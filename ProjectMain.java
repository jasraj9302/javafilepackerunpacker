...
class ProjectLogin extends Template implements ActionListener , Runnable
{
    ...
    ProjectLogin()
    {
        ...
        TopLabel.setText("Project Packer Unpacker : Login");
        ...
        SUBMIT.setBounds(20,50,ssize.width,ssize.height);
    ...
    public void addActionListener(ActionEvent ae)
    {
        ...
        if(ae.getSource() == SUBMIT)
        {
            if(Validate(value1,value2) == false)
            {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this, " Short username","Project packer unpacker",JOptionPane.ERROR_MESSAGE);
            }
